...
/* @var $modelErrors array */
/* @var $edittedResumeID int */
/* @var $edittedResume Resume */
/* @var $model Resume */
?>
        ...
        <div class="col-12">
            ...
            <div class="row mb16">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    ?>
                    <div>
                        <a href="http://myheadhunter/web/index.php?r=//resume/edit-reg-resume-delete&edittedResumeID=<?= $edittedResumeID ?>">Удалить
                            место работы</a></div>
                </div>
            </div>
            <!-- <div class="row mb24">
