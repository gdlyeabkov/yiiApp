                ...
                <?php foreach ($myResumeList as $oneResume): ?>
                    <div class="tabs__content active">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="d-flex">
                                    <div class="paragraph mb8 mr16">У вас <span><?= count($myResumeList) ?></span>
                                        резюме
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="my-resume-dropdown dropdown show mb8">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item"
                                                   href="http://myheadhunter/web/index.php?r=//resume/edit-reg-resume&edittedResumeID=<?= $oneResume->id ?>">Редактировать</a>
                                                <a class="dropdown-item"
                                                   href="http://myheadhunter/web/index.php?r=//resume/edit-reg-resume-remove&edittedResumeID=<?= $oneResume->id ?>">Удалить</a>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-wrap mobile-mb12">
                                                <a class="mr16"
                                                   href="http://myheadhunter/web/index.php?r=//resume/resume-view&id=<?= $oneResume->id ?>"">Открыть</a>
                                            </div>
